...
const About = () => (
  <div>
    ...
    <em>An anecdote is a brief, revealing account of an individual person or an incident.
      ...
      is not simply to provoke laughter but to reveal a truth more general
      than the brief tale itself, such as to characterize a person by delineating
      a specific quirk or trait, to communicate an abstract idea about a
